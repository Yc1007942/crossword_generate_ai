...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        for variables in self.domains:
            ...
            self.domains[variables].difference_update(words_to_remove)
        ...
        def count_conflicts(value):
            ...
            for neighbor in self.crossword.neighbors(var):
                if neighbor not in assignment:
                    count += sum(1 for word in self.domains[neighbor] if word[self.crossword.overlaps[var, neighbor][1]] != value[self.crossword.overlaps[var, neighbor][0]])
            return count
